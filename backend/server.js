...
app.use(cors({
  origin: function(origin, callback) {
    // Allow same-origin requests (no origin header) and any Railway/custom domain
    ...
    callback(null, true); // permissive — tighten with API_SECRET in production
  },
  credentials: true,
}));
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`   Railway:  listening on 0.0.0.0 for proxy\n`);
});
